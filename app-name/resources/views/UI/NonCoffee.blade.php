...
@include('Header')
<div id="Tittle" style="color: #5F5D5E;margin-top:50px">NON COFFEE</div>
<div id="Description">Minuman non-kopi adalah berbagai jenis minuman yang tidak mengandung kopi dan sering kali menawarkan rasa yang berbeda serta manfaat yang unik.</div>
    <body>
        <div class="wrapper">
...
<script src="{{asset('assets/js/NonCoffee.js')}}"></script>
...
<script defer src="https://unpkg.com/alpinejs@3.10.2/dist/cdn.min.js"></script>
    ...
    <script>
        ...
        function sendRatingToServer(columnName, rating, NoncoffeeId) {
            // debugger
            console.log(columnName, rating, NoncoffeeId);
            ...
            const requestData = {
                ...
                rating: rating,
                ID: NoncoffeeId  // Menggunakan 'ID' sesuai dengan nama kolom di database
            };

            // Kirim POST request ke server menggunakan jQuery
            $.ajax({
                url: `/Menu-NonCoffee/${NoncoffeeId}/rating`,  // Gunakan coffeeId dalam URL
                type: 'POST',
        ...
        function getRatingFromServer(columnName, NoncoffeeId, ratingDiv) {
            // Kirim permintaan GET ke server untuk mendapatkan rating
            $.ajax({
                url: `/Menu-NonCoffee/${NoncoffeeId}/rating?columnName=${columnName}`, // Gunakan NoncoffeeId dalam URL
                type: 'GET',
                success: function(data) {
                    console.log('Success:', data);
