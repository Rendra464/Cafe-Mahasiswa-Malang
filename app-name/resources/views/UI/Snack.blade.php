...
@include('Header')
<div id="Tittle" style="color: #5F5D5E;margin-top:50px">SNACK</div>
<div id="Description">Menu makanan ringan yang mencakup berbagai pilihan yang cocok untuk dinikmati sebagai teman minum kopi atau sebagai camilan ringan.</div>
    <body>
        <div class="wrapper">
            ...
            <div id="buttons" style="text-align:center">
                ...
                <button class="button-value" onclick="filterProduct('Snack')">
                    Snack
                </button>
                <button class="button-value" onclick="filterProduct('Topping')">
                    Topping
                </button>
            </div>
...
<script defer src="https://unpkg.com/alpinejs@3.10.2/dist/cdn.min.js"></script>
    <script>
        ...
        function sendRatingToServer(columnName, rating, SnackId) {
            debugger
            console.log(columnName, rating, SnackId);
            ...
            const requestData = {
                ...
                rating: rating,
                ID: SnackId  // Menggunakan 'ID' sesuai dengan nama kolom di database
            };

            // Kirim POST request ke server menggunakan jQuery
            $.ajax({
                url: `/Menu-Snack/${SnackId}/rating`,  // Gunakan SnackId dalam URL
                type: 'POST',
        ...
        function getRatingFromServer(columnName, SnackId, ratingDiv) {
            // Kirim permintaan GET ke server untuk mendapatkan rating
            $.ajax({
                url: `/Menu-Snack/${SnackId}/rating?columnName=${columnName}`, // Gunakan SnackId dalam URL
                type: 'GET',
                success: function(data) {
                    console.log('Success:', data);
