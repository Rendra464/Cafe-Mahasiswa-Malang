...
@include('Header')
<div id="Tittle" style="color: #5F5D5E;margin-top:50px">FOOD</div>
<div id="Description">Menu makanan ini mencakup pilihan-pilihan yang lebih substansial dan memuaskan.</div>
    <body>
        <div class="wrapper">
            ...
            <div id="buttons" style="text-align:center">
                ...
                <button class="button-value" onclick="filterProduct('Noodle')">
                    Noodle
                </button>
                <button class="button-value" onclick="filterProduct('Nastel')">
                    Nastel
                </button>
            </div>
...
<script defer src="https://unpkg.com/alpinejs@3.10.2/dist/cdn.min.js"></script>
    ...
    <script>
        ...
        function sendRatingToServer(columnName, rating, FoodId) {
            // debugger
            console.log(columnName, rating, FoodId);
            ...
            const requestData = {
                ...
                rating: rating,
                ID: FoodId  // Menggunakan 'ID' sesuai dengan nama kolom di database
            };

            // Kirim POST request ke server menggunakan jQuery
            $.ajax({
                url: `/Menu-Food/${FoodId}/rating`,  // Gunakan FoodId dalam URL
                type: 'POST',
        ...
        function getRatingFromServer(columnName, FoodId, ratingDiv) {
            // Kirim permintaan GET ke server untuk mendapatkan rating
            $.ajax({
                url: `/Menu-Food/${FoodId}/rating?columnName=${columnName}`, // Gunakan FoodId dalam URL
                type: 'GET',
                success: function(data) {
                    console.log('Success:', data);
        ...
        // Membuat kartu produk desktop
        for (let i of products.dataFood) {
        ...
        // Membuat kartu produk responsive
        for (let i of products.dataFood) {
            let card = document.createElement("div");
            card.classList.add("card", i.category, "hide");
            card.addEventListener('click', function () {
