...
<div id="Description">Minuman tradisional mencerminkan warisan budaya yang kaya dari berbagai belahan dunia.</div>
    ...
    <script>
        ...
        function clearLocalStorageForDomain(domain) {
            // Dapatkan semua kunci yang ada di localStorage
            let keys = Object.keys(localStorage);

            // Loop melalui setiap kunci dan hapus jika domain sesuai
        ...
        // Contoh penggunaan: Hapus semua data yang berhubungan dengan domain 'example.com'

        window.addEventListener('beforeunload', function() {
            // Panggil fungsi clearLocalStorageForDomain di sini dengan domain yang sesuai
            clearLocalStorageForDomain('https://cdn.botpress.cloud');
        });
        ...
        function sendRatingToServer(columnName, rating, TraditionalDrinkId) {
            ...
            $.ajax({
                url: `/Menu-TraditionalDrink/${TraditionalDrinkId}/rating`,  // Gunakan TraditionalDrinkId dalam URL
                type: 'POST',
