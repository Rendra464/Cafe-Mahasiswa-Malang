...
<body class="font-sans text-gray-900 bg-white">
    ...
    <section class="bg-[#0B7941] py-20 text-white">
        <div class="max-w-screen-lg mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div class="flex flex-col items-center p-6 rounded-lg transition duration-300 hover:scale-105 cursor-pointer">
    ...
    <section class="bg-white py-20">
        <div class="max-w-screen-lg mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <div class="bg-[#F9F9F9] rounded-2xl shadow-lg p-6 text-center transition hover:scale-105 duration-300">
                    <img src="Menu-Items/Coffee/27 KSTG .png" alt="Espresso" class="w-full h-48 object-cover">
                    <h3 class="text-xl font-semibold text-[#0B7941] mb-2">KSTG</h3>
                    <p class="text-gray-600 text-sm mb-4">Rp 8.000</p>
                ...
                <div class="bg-[#F9F9F9] rounded-2xl shadow-lg p-6 text-center transition hover:scale-105 duration-300">
                    <img src="Menu-Items/Traditional-drink/40 wedang jahe gula aren.png" alt="Espresso" class="w-full h-48 object-cover">
                    <h3 class="text-xl font-semibold text-[#0B7941] mb-2">Ginger tea with palm sugar</h3>
                    <p class="text-gray-600 text-sm mb-4">Rp 10.000</p>
                    <button class="bg-[#0B7941] text-white px-4 py-2 rounded-full hover:bg-[#096636] transition duration-300">
                        Order Now
                    </button>
                </div>
                ...
                <div class="bg-[#F9F9F9] rounded-2xl shadow-lg p-6 text-center transition hover:scale-105 duration-300">
                    <img src="Menu-Items/Coffee/public\Menu-Items\Modern-Drink\62 vanilla latte ice.png" alt="Espresso" class="w-full h-48 object-cover">
                    <h3 class="text-xl font-semibold text-[#0B7941] mb-2">Vanilla Latte</h3>
                    <p class="text-gray-600 text-sm mb-4">Rp 35.000</p>
                    <button class="bg-[#0B7941] text-white px-4 py-2 rounded-full hover:bg-[#096636] transition duration-300">
                        Order Now
                    </button>
                </div>
