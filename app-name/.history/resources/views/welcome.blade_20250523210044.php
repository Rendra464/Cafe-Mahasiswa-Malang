...
<body class="font-sans text-gray-900 bg-white">
    ...
    <section class="bg-[#f5f5f5] text-gray-800 py-16 px-6">
        <div class="max-w-5xl mx-auto text-center">
            ...
            <div class="mt-8 relative max-w-xl mx-auto overflow-hidden rounded-xl shadow-md">
                ...
                <button id="prev" class="absolute left-2 top-1/2 -translate-y-1/2 bg-white/70 hover:bg-white text-black p-2 rounded-full shadow">
                    &#8592;
                </button>
                <button id="next" class="absolute right-2 top-1/2 -translate-y-1/2 bg-white/70 hover:bg-white text-black p-2 rounded-full shadow">
                    &#8594;
                </button>
            </div>
        </div>
...
<script>
    ...
    carousel.parentElement.addEventListener('mouseleave', () => autoPlay = setInterval(nextSlide, 3000));
