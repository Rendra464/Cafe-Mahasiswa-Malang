...
<body>
    ...
    <button class="custom-button" style="position: absolute; top: 94%; left: 20%;">Hot</button>
    <button class="custom-button" style="position: absolute; top: 94%; left: 50%;">food</button>
    <button class="custom-button" style="position: absolute; top: 94%; left: 70%;">ice</button>
    </div>
