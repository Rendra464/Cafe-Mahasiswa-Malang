...
<body>
    ...
    <div style="background-color:#073C21;height:671px">
        ...
        <div style="display:flex;align-items: start;">
            ...
            <div style="margin-left:8%">
                <div id="TittleCafe" style="padding-top: 30%;font-weight:300; font-size:16px;text-align:left;width:100%">FAQ</div>
            </div>
            <div style="margin-left:8%">
                <div id="TittleCafe" style="padding-top: 30%;font-weight:300; font-size:16px;text-align:left;width:100%">Email</div>
