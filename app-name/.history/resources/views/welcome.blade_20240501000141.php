...
<body>
    ...
    <div style="background-color:#073C21;height:671px">
        ...
        <div id="TittleCafe" style="position: absolute; top: 753%; left: 55%;font-weight:300; font-size:16px;text-align:left;width:35%">About Us</div>
        <div id="TittleCafe" style="position: absolute; top: 753%; left: 55%;font-weight:300; font-size:16px;text-align:left;width:35%">Help & Support</div>
    </div>
