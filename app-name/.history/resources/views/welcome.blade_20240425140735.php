...
<body>
    ...
    <div style="text-align: center; position: relative;">
        ...
        <div id="Tittle" style="position: absolute; top: 50%; left: 58%; transform: translate(-50%, 0%);">SAM HUGET</div>
        <button class="custom-button" style="position: absolute; top: 50%; left: 58%;">Lets Talk</button>
    </div>
