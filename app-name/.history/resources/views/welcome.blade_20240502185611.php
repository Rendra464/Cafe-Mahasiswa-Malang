...
<body>
    ...
    <div style="background-color:#073C21;height:671px">
        ...
        <div style="margin-left:5%;text-align:left;padding-top: 10%;">KAMPUNG MAHASISWA MALANG</div>
        <div style="">About</div>
        <div style="">FAQ</div>
        ...
        <div id="TittleCafe" style="">About</div>
        <div id="TittleCafe" style="">FAQ</div>
        <div id="TittleCafe" style="">Contact Us</div>
