...
@include('Header')
<div id="Tittle" style="color: #5F5D5E;margin-top:50px">MODERN DRINK</div>
<div id="Description">Berbagai jenis minuman yang sering kali inovatif dan trendi, memadukan rasa, tekstur, dan presentasi yang unik.</div>
    <body>
        <div class="wrapper">
...
<script defer src="https://unpkg.com/alpinejs@3.10.2/dist/cdn.min.js"></script>
    ...
    <script>
        ...
        function sendRatingToServer(columnName, rating, ModernDrinkId) {
            // debugger
            console.log(columnName, rating, ModernDrinkId);
            ...
            const requestData = {
                ...
                rating: rating,
                ID: ModernDrinkId  // Menggunakan 'ID' sesuai dengan nama kolom di database
            };

            // Kirim POST request ke server menggunakan jQuery
            $.ajax({
                url: `/Menu-ModernDrink/${ModernDrinkId}/rating`,  // Gunakan ModernDrinkId dalam URL
                type: 'POST',
        ...
        function getRatingFromServer(columnName, ModernDrinkId, ratingDiv) {
            // Kirim permintaan GET ke server untuk mendapatkan rating
            $.ajax({
                url: `/Menu-ModernDrink/${ModernDrinkId}/rating?columnName=${columnName}`, // Gunakan ModernDrinkId dalam URL
                type: 'GET',
                success: function(data) {
                    console.log('Success:', data);
