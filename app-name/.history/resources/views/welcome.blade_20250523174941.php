        ...
        <div class="max-w-screen-lg mx-auto px-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                ...
                <div class="bg-[#F9F9F9] rounded-2xl shadow-lg p-6 text-center transition hover:scale-105 duration-300">
                    <img src="C:\Users\rendr\app-name\public\Menu-Items\Coffee/27 KSTG .png" alt="Espresso" class="w-full h-48 object-cover">
                    <h3 class="text-xl font-semibold text-[#0B7941] mb-2">Espresso</h3>
                    <p class="text-gray-600 text-sm mb-4">Rp 25.000</p>
