...
<body class="font-sans text-gray-900 bg-white">
    ...
    <section class="bg-[#0B7941] py-10 text-white">
        <div class="max-w-screen-lg mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            <img src="coffee-icon.svg" alt="Coffee" class="w-16 h-16">
            <p class="mt-2 font-semibold">Coffee</p>
            </div>

            <!-- Iced Coffee Icon -->
            <div class="flex flex-col items-center">
            <img src="iced-coffee-icon.svg" alt="Iced Coffee" class="w-16 h-16">
            <p class="mt-2 font-semibold">Iced Coffee</p>
            </div>

            <!-- Dessert Icon -->
            <div class="flex flex-col items-center">
            <img src="dessert-icon.svg" alt="Dessert" class="w-16 h-16">
            <p class="mt-2 font-semibold">Dessert</p>
            </div>

            <!-- Food Icon -->
            <div class="flex flex-col items-center">
            <img src="food-icon.svg" alt="Food" class="w-16 h-16">
            <p class="mt-2 font-semibold">Food</p>
            </div>
