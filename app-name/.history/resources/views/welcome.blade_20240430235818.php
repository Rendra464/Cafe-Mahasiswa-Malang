...
<body>
    ...
    <div style="background-color:#073C21;height:671px">
        ...
        <div id="TittleCafe" style="position: absolute; top: 740%; left: 60%;">About</div>
        <div id="TittleCafe" style="position: absolute; top: 740%; left: 60%;">FAQ</div>
        <div id="TittleCafe" style="position: absolute; top: 740%; left: 60%;">Contact Us</div>
    </div>
