...
<div class="min-h-screen bg-gray-100 py-8">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <!-- TikTok -->
            <div class="bg-white/10 backdrop-blur-sm rounded-lg shadow-lg p-6 text-center transition-transform duration-300 hover:scale-105">
                <div class="flex justify-center mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" class="text-white">
                        <path fill="currentColor" d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/>
                    </svg>
                </div>
                <h2 class="text-xl font-semibold mb-2 text-white">TikTok</h2>
                <p class="text-gray-200 mb-4">Check out our TikTok for fun and engaging content.</p>
                <a href="https://www.tiktok.com/@kampungmahasiswamalang" target="_blank" class="bg-white/20 text-white px-6 py-2 rounded-full hover:bg-white/30 transition-all duration-300 inline-block">
                    Follow Us
                </a>
            </div>
