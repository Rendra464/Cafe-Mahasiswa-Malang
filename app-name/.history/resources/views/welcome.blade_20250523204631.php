...
<body class="font-sans text-gray-900 bg-white">
    ...
    <section class="bg-[#f5f5f5] text-gray-800 py-16 px-6">
        <div class="max-w-5xl mx-auto text-center">
            ...
            <p class="text-lg leading-relaxed">
                Kampung Mahasiswa Malang adalah platform yang didedikasikan untuk membantu mahasiswa menemukan tempat makan, kebutuhan harian, dan produk lokal dengan mudah. Kami hadir untuk mempermudah hidupmu sebagai mahasiswa di Malang!
            </p>
            <div class="mt-8 flex justify-center">
                <img src="https://source.unsplash.com/600x300/?university,campus" alt="Tentang Kami" class="rounded-xl shadow-md w-full max-w-xl object-cover">
            </div>
        </div>
    </section>
    ...
    <section class="bg-white py-16 px-6">
        <div class="max-w-5xl mx-auto text-center">
            <h2 class="text-3xl font-bold mb-4 text-gray-800">Lokasi Kami</h2>
            <p class="text-lg text-gray-600 mb-6">Temukan kami di pusat aktivitas mahasiswa Malang. Klik pada peta untuk navigasi langsung.</p>
            <div class="overflow-hidden rounded-xl shadow-lg border border-gray-200">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3958.409502037863!2d112.615837!3d-7.191402!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7fb9f2aeed91d%3A0x85bd74de3ad5b7b3!2sKampung%20Mahasiswa%20Malang!5e0!3m2!1sid!2sid!4v1684567890000"
                    width="100%"
                    height="400"
                    style="border:0;"
                    allowfullscreen=""
