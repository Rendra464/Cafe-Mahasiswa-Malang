...
<head>
    ...
    <div style="text-align: center; position: relative;">
        ...
        <button class="custom-button" id="Coffee" style="position: absolute; top: 94%; left: 12%;">Coffee</button>
        <button class="custom-button" id="" style="position: absolute; top: 94%; left: 42%;">Non-Coffee</button>
        <button class="custom-button" id="" style="position: absolute; top: 94%; left: 72%;">Modern Drink</button>
    </div>
    ...
    <div style="text-align: center; position: relative; margin-top:100px">
        ...
        <button class="custom-button" id="" style="position: absolute; top: 94%; left: 12%;">Traditional Drink</button>
        <button class="custom-button" id="" style="position: absolute; top: 94%; left: 42%;">Food</button>
        <button class="custom-button" id="" style="position: absolute; top: 94%; left: 72%;">Snack</button>
    </div>
    ...
    <div style="background-color:#073C21;height:671px">
        ...
        <div style="display:flex;align-items: start;">
            ...
            <div style="margin-left:8%">
                <div id="TittleCafe" style="padding-top: 30%;font-weight:300; font-size:16px;text-align:left;width:100%">Menu</div>
                <div id="TittleCafe" style="padding-top: 30%;font-weight:300; font-size:16px;text-align:left;width:100%">About Us</div>
            </div>
            <div style="margin-left:11.6%">
                <div id="TittleCafe" style="padding-top: 75%;font-weight:300; font-size:16px;text-align:left;width:100%">FAQ</div>
            </div>
            <div style="margin-left:12%">
                <div id="TittleCafe" style="padding-top: 20%;font-weight:300; font-size:16px;text-align:left;width:100%">Email</div>
                <div id="TittleCafe" style="padding-top: 20%;font-weight:300; font-size:16px;text-align:left;width:100%">No Telephone</div>
                <div id="TittleCafe" style="padding-top: 20%;font-weight:300; font-size:16px;text-align:left;width:100%">Website Hosting</div>
                <div id="TittleCafe" style="padding-top: 20%;font-weight:300; font-size:16px;text-align:left;width:100%">Address</div>
            </div>
        </div>
        <!-- <div id="TittleCafe" style="margin-left:5%;text-align:left;padding-top: 10%">KAMPUNG MAHASISWA MALANG</div> -->
        <!-- <div id="TittleCafe" style="margin-left:5%;padding-top: 1%;font-weight:300; font-size:16px;text-align:left;width:35%">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</div> -->
        ...
        <button class="custom-button" style="margin-top:40px;margin-left:5%;background-color:#FFFFFF; color:#5F5D5E">Login</button>
        <!-- <div id="TittleCafe" style="position: absolute; top: 740%; left: 5%;">KAMPUNG MAHASISWA MALANG</div>
        <div id="TittleCafe" style="position: absolute; top: 753%; left: 5%;font-weight:300; font-size:16px;text-align:left;width:35%">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</div>
        <div style="position: absolute; top: 785%; left: 5%;">
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="33" height="33" style="fill:#FFFFFF" viewBox="0 0 30 30">
                <path d="M15,3C8.373,3,3,8.373,3,15c0,6.016,4.432,10.984,10.206,11.852V18.18h-2.969v-3.154h2.969v-2.099c0-3.475,1.693-5,4.581-5 c1.383,0,2.115,0.103,2.461,0.149v2.753h-1.97c-1.226,0-1.654,1.163-1.654,2.473v1.724h3.593L19.73,18.18h-3.106v8.697 C22.481,26.083,27,21.075,27,15C27,8.373,21.627,3,15,3z"></path>
            </svg>
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="33" height="33" style="fill:#FFFFFF;margin-left:20px" viewBox="0 0 50 50">
        ...
        <div id="TittleCafe" style="position: absolute; top: 740%; left: 55%;font-size:24px;">About</div>
        <div id="TittleCafe" style="position: absolute; top: 740%; left: 65%;font-size:24px;">FAQ</div>
        <div id="TittleCafe" style="position: absolute; top: 740%; left: 75%;font-size:24px;">Contact Us</div>

        <div id="TittleCafe" style="position: absolute; top: 753%; left: 55%;font-weight:300; font-size:16px;text-align:left;width:35%">Menu</div>
        <div id="TittleCafe" style="position: absolute; top: 763%; left: 55%;font-weight:300; font-size:16px;text-align:left;width:35%">About Us</div>

        <div id="TittleCafe" style="position: absolute; top: 753%; left: 65%;font-weight:300; font-size:16px;text-align:left;width:35%">FAQ</div>

        <div id="TittleCafe" style="position: absolute; top: 753%; left: 75%;font-weight:300; font-size:16px;text-align:left;width:35%">Email</div>
        <div id="TittleCafe" style="position: absolute; top: 763%; left: 75%;font-weight:300; font-size:16px;text-align:left;width:35%">No Telephone</div>
        <div id="TittleCafe" style="position: absolute; top: 773%; left: 75%;font-weight:300; font-size:16px;text-align:left;width:35%">Website Hosting</div>
        <div id="TittleCafe" style="position: absolute; top: 783%; left: 75%;font-weight:300; font-size:16px;text-align:left;width:35%">Address</div>

        <button class="custom-button" style="position: absolute; top: 800%; left: 5%;background-color:#FFFFFF; color:#5F5D5E">Login</button> -->
    </div>
