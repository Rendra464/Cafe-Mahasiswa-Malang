...
<body>
    ...
    <div style="background-color:#073C21;height:671px">
        ...
        <div id="TittleCafe" style="position: absolute; top: 740%; left: 60%;font-size:16px;">About</div>
        <div id="TittleCafe" style="position: absolute; top: 740%; left: 70%;">FAQ</div>
        <div id="TittleCafe" style="position: absolute; top: 740%; left: 80%;">Contact Us</div>
    </div>
