...
<body>
    ...
    <div style="text-align: center; position: relative;">
        ...
        <div id="Tittle" style="position: absolute; top: 35%; left: 25%; transform: translate(-50%, 0%); font-size:24px">Menu</div>
        <div id="Tittle" style="position: absolute; top: 35%; left: 65%; transform: translate(-50%, 0%); font-size:24px">Home</div>
        <div id="Tittle" style="position: absolute; top: 35%; left: 85%; transform: translate(-50%, 0%); font-size:24px">Home</div>
