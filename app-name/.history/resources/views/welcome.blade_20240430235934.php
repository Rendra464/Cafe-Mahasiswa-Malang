...
<body>
    ...
    <div style="background-color:#073C21;height:671px">
        ...
        <div id="TittleCafe" style="position: absolute; top: 753%; left: 5%;font-weight:300; font-size:16px;text-align:left;width:40%">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</div>
        <div style="position: absolute; top: 780%; left: 5%;">
        ...
        <div id="TittleCafe" style="position: absolute; top: 740%; left: 550%;font-size:24px;">About</div>
        <div id="TittleCafe" style="position: absolute; top: 740%; left: 75%;font-size:24px;">FAQ</div>
        <div id="TittleCafe" style="position: absolute; top: 740%; left: 85%;font-size:24px;">Contact Us</div>
    </div>
