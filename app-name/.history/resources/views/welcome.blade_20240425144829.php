...
<body>
    ...
    <button class="custom-button" style="position: absolute; top: 100%; left: 42%;">Hot</button>
    <button class="custom-button" style="position: absolute; top: 100%; left: 42%;">food</button>
    <button class="custom-button" style="position: absolute; top: 100%; left: 42%;">ice</button>
