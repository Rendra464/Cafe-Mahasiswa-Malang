...
<body>
    ...
    <div style="text-align: center; position: relative;">
        <img src="{{ URL('Coffee.png') }}" alt="" style="margin-left:50px">
        <img src="{{ URL('Non Coffee.png') }}" alt="" style="margin-left:150px">
        <img src="{{ URL('Modern Drink.png') }}" alt="" style="margin-left:150px">
