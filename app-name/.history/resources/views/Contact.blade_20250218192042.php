...
<div>
    ...
    <div style="font-family: Inter, sans-serif; font-weight: bold;text-align:left;font-size:36px;margin-left: 100px;margin-top: -20px;background: -webkit-linear-gradient(#444444, #0B7941);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
        Product
    </div>
