...
<body class="font-sans text-gray-900 bg-white">
    ...
    <footer class="bg-[#083d24] text-white py-10 text-center text-sm">
        <p>Kampung Mahasiswa Malang © 2025. All rights reserved.</p>
        <p class="mt-2">Follow us on Instagram @kampungcoffee</p>
        <div class="max-w-screen-lg mx-auto grid grid-cols-2 md:grid-cols-3 text-center">
            <div class="flex flex-col items-center p-6 hover:scale-105 cursor-pointer" >
