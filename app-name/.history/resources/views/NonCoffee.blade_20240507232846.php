    ...
    <body>
        <div class="wrapper">
            ...
            <div id="buttons" style="text-align:center">
                ...
                <button class="button-value" onclick="filterProduct('NonCoffeeCold')">
                    NonCoffeeCold
                </button>
                <button class="button-value" onclick="filterProduct('NonCoffeeHot')">
                    NonCoffeeHot
                </button>
            </div>
            <div id="products">
                <div id="popup1" class="overlay">
                    <div class="popup">
                        ...
                        <div class="ClickMenu">
                            ...
                            <div class="content" style="margin-top:25%">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
                        </div>
                    </div>
                </div>
            </div>
