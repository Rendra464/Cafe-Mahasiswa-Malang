...
<body>
    <section class="relative h-48 bg-cover bg-center">
        ...
        <header class="absolute top-6 left-1/2 transform -translate-x-1/2 z-50 w-[90%] max-w-6xl">
            <nav class="bg-[#0B7941] backdrop-blur-md border border-white/20 px-6 py-3 rounded-full flex items-center justify-between text-white shadow-lg">
            ...
            <div id="mobile-menu" class="md:hidden mt-2 bg-[#0B7941]/10 backdrop-blur-md border border-white/20 rounded-xl text-white shadow-lg px-6 py-4 hidden transition-all">
