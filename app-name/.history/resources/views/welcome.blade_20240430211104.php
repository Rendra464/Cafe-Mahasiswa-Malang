...
<body>
    ...
    <div style="text-align: center; position: relative;">
        <img src="{{ URL('Coffee.jpg') }}" alt="" style="margin-left:50px;width:300px;height:40000px;">
        <img src="{{ URL('Non Coffee.jpg') }}" alt="" style="margin-left:150px;width:300px;height400px;">
        <img src="{{ URL('Modern Drink.jpg') }}" alt="" style="margin-left:150px;width:300px;height400px;">
