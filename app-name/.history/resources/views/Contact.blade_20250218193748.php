...
<div class="min-h-screen bg-gray-100 py-8">
    <div class="container mx-auto px-4">
        <h1 style="font-family: Inter, sans-serif; font-weight: bold;text-align:center;font-size:48px;margin-left: 100px;margin-top: -20px;background: -webkit-linear-gradient(#444444, #0B7941);-webkit-background-clip: text;-webkit-text-fill-color: transparent;">
            Contact Us
        </h1>
