    ...
    <section class="relative h-auto bg-cover bg-center" style="background-image: url('/LandingPage.JPEG');">
        ...
        <div class="relative z-10 flex items-center justify-center md:justify-start h-full text-white px-4">
            <div class="text-center md:text-left">
                <h1 class="text-5xl md:text-6xl font-bold mb-4">Welcome to Kampung Mahasiswa Malang</h1>
                <p class="text-xl md:text-2xl mb-4">Great Coffee. No Compromise.</p>
                ...
                <a href="#menu" class="inline-block bg-#FFFFFF-500 hover:bg-#FFFFFF-600 text-black px-6 py-3 rounded-lg font-semibold transition">
                    Order Now
                </a>
            </div>
        </div>
