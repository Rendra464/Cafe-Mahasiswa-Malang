    ...
    <section class="bg-[#0B7941] py-10 text-white">
        <div class="max-w-screen-lg mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 2v2m4-2v2m4-2v2M3 6h18M4 6v10a4 4 0 004 4h4a4 4 0 004-4V6H4z"/>
            </svg>
            <p class="text-lg font-semibold">Fresh Coffee</p>
            </div>
            <div class="flex flex-col items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M4 6h16M4 10h16M10 14h4v6h-4z"/>
      </svg>
      <p class="text-lg font-semibold">Delicious Food</p>
            </div>
            <div class="flex flex-col items-center">
