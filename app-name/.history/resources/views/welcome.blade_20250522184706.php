...
<body class="font-sans text-gray-900 bg-white">
    <section class="relative h-screen bg-cover bg-center" style="background-image: url('/LandingPage.JPEG');">
        ...
        <div class="relative z-10 flex items-center justify-center h-full text-center text-white px-4">
            <div>
                <h1 class="text-5xl md:text-6xl font-bold mb-4">Selamat Datang di Kopi Mantap</h1>
                <p class="text-xl md:text-2xl mb-6">Nikmati aroma dan cita rasa kopi terbaik dari biji pilihan lokal</p>
