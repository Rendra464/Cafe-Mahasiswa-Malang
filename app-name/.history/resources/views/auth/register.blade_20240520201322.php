            ...
            <div class="signin-signup">
                <form method="POST" action="{{ route('register') }}">
					...
					<div class="input-field">
						...
						<input id="password" placeholder="Username" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                        @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
        ...
        <div class="panels-container-login">
            <div class="panel left-panel">
                <div class="content">
                    ...
                    <button class="btn-login transparent" id="sign-up-btn" style="background:#FFFFFF; border-radius:15px">
