    ...
    <div class="container-login sign-up-mode">
            ...
            <div class="signin-signup">
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="input-field">
                        ...
                        @error('name')
                            <span class="invalid-feedback" role="alert" style="text-align:center;width:300px;color:red;">
        ...
        <div class="panels-container-login">
            <div class="panel left-panel">
                <div class="content">
                    <h3>New here ?</h3>
                    <button class="btn-login transparent" id="sign-up-btn" style="background:#FFFFFF; border-radius:15px; margin-top:30px">
                        <a class="nav-link" href="{{ route('register') }}" style="Color:#073C21;">{{ __('Register') }}</a>
                    </button>
                </div>
            ...
            <div class="panel right-panel">
				<div class="content">
					...
					<button class="btn transparent" id="sign-in-btn" style="background:#FFFFFF; border-radius:15px;margin-top:30px">
                        <a class="nav-link" href="{{ route('login') }}" style="Color:#073C21;">{{ __('Login') }}</a>
					</button>
				</div>
				<!-- <img src="https://i.ibb.co/nP8H853/Mobile-login-rafiki.png"  class="image" alt="" /> -->
                <img src="{{ URL('Barista.png') }}" alt="" class="image" style="border-radius:100px">
			</div>
        </div>
    </div>
