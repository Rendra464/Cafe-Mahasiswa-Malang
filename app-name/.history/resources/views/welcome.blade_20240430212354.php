...
<body>
    ...
    <div style="text-align: center; position: relative;">
        <div style="text-align: left; display: flex; align-items: flex-start;">
            <img src="{{ URL('Header.png') }}" alt="" style="margin-left:50px; margin-top: 50px;width:563px;height:400px">
            <div id="Description" style="margin-left:148px; margin-top:150px;text-align:right; width:563px">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</div>
        </div>
