...
<body>
    ...
    <div style="text-align: center; position: relative; margin-top:40px">
        ...
        <button class="custom-button" style="position: absolute; top: 124%; left: 13%;">Hot</button>
        <button class="custom-button" style="position: absolute; top: 124%; left: 44%;">food</button>
        <button class="custom-button" style="position: absolute; top: 124%; left: 74%;">ice</button>
    </div>
