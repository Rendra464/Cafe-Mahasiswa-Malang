...
<body>
    ...
    <div style="background-color:#073C21;height:671px">
        ...
        <div id="TittleCafe" style="position: absolute; top: 753%; left: 75%;font-weight:300; font-size:16px;text-align:left;width:35%">No Telephone</div>
        <div id="TittleCafe" style="position: absolute; top: 753%; left: 75%;font-weight:300; font-size:16px;text-align:left;width:35%">Website Hosting</div>
        <div id="TittleCafe" style="position: absolute; top: 753%; left: 75%;font-weight:300; font-size:16px;text-align:left;width:35%">Address</div>
    </div>
