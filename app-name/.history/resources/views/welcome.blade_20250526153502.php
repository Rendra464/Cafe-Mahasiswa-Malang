    ...
    <footer class="bg-[#083d24] text-white py-10 text-center text-sm">
        <div class="max-w-screen-lg mx-auto px-4">
            ...
            <div class="grid grid-cols-3 md:grid-cols-3 gap-4 mt-6">
                ...
                <a href="https://www.tiktok.com/@kampungmahasiswamalanghttps://wa.me/6282137453297" class="flex flex-col items-center p-4 hover:scale-110 transition-transform duration-200 cursor-pointer">
