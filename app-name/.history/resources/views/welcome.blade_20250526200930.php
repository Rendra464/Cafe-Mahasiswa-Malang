...
<body class="font-sans text-gray-900 bg-white scroll-smooth">
    ...
    <section id="about" class="bg-[#f5f5f5] text-gray-800 py-16 px-6">
        <div class="max-w-5xl mx-auto text-center">
            <h2 class="text-3xl font-bold text-center text-[#0B7941] mb-10">About us</h2>
            ...
            <div class="mt-8 overflow-hidden rounded-xl shadow-md w-full max-w-xl mx-auto">
                <div id="carousel" class="flex transition-transform duration-300 ease-in-out w-full">
                    ...
                    <img src="/IMG_9792.JPEG" class="object-cover w-full shrink-0" alt="Campus 2">
                    <img src="/IMG_9793.JPEG" class="object-cover w-full shrink-0" alt="Campus 3">
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white py-16 px-6">
        <div class="max-w-5xl mx-auto text-center">
            <h2 class="text-3xl font-bold text-center text-[#0B7941] mb-10">Our Location</h2>
    ...
    <footer class="bg-[#083d24] text-white py-10 text-center text-sm">
        <div class="max-w-screen-lg mx-auto px-4">
            ...
            <div class="grid grid-cols-3 md:grid-cols-3 gap-4 mt-6">
                <a href="https://www.instagram.com/kampungmahasiswamalang/" class="flex flex-col items-center p-4 hover:scale-110 transition-transform duration-200 cursor-pointer">
                ...
                <a href="https://www.tiktok.com/@kampungmahasiswamalang" class="flex flex-col items-center p-4 hover:scale-110 transition-transform duration-200 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-tiktok" viewBox="0 0 16 16">
                        <path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3z"/>
                    </svg>
                </a>
                <a href="https://wa.me/6282137453297" class="flex flex-col items-center p-4 hover:scale-110 transition-transform duration-200 cursor-pointer">
