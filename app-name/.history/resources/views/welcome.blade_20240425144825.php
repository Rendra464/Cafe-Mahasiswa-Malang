...
<body>
    ...
    <button class="custom-button" style="position: absolute; top: 75%; left: 42%;">food</button>
    <button class="custom-button" style="position: absolute; top: 75%; left: 42%;">ice</button>
