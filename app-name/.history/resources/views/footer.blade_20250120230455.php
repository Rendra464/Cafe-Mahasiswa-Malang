    ...
    <div style="background-color:#073C21;height:571px">
        ...
        <div style="margin-left:5%;text-align:left;margin-top: -30px;display:flex">
                ...
                <a href="https://www.tiktok.com/@kampungmahasiswamalang" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="33" height="33" style="fill:#FFFFFF;margin-left:20px" class="bi bi-tiktok" viewBox="0 0 16 16">
    ...
    <div style="background-color: #073C21; padding: 20px 0;">
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; padding: 40px 5%; max-width: 1200px; margin: auto;">
            ...
            <div style="display: flex; flex-direction: column; gap: 10px;">
                ...
                <a id="TittleCafe" style="margin-left: auto; color: white; font-size: 18px; cursor: pointer;">About</a>
                <a id="TittleCafe" style="margin-left: 30px; color: white; font-size: 18px; cursor: pointer;">Support</a>
            </div>
        </div>
