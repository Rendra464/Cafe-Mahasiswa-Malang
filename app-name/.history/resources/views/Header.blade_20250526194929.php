        ...
        <header class="absolute top-6 left-1/2 transform -translate-x-1/2 z-50 w-[90%] max-w-6xl">
            ...
            <div id="mobile-menu" class="md:hidden mt-2 bg-[#073C21] backdrop-blur-md border border-white/20 rounded-xl text-white shadow-lg px-6 py-4 opacity-0 scale-95 transform transition-all duration-300 origin-top pointer-events-none">
                <ul class="flex flex-col gap-4 text-sm font-semibold uppercase">
                    ...
                    <li><a href="/Menu-Coffee" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">Coffee</a></li>
                    <li><a href="/Menu-NonCoffee" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">NonCoffee</a></li>
                    <li><a href="/Menu-ModernDrink" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">ModernDrink</a></li>
                    <li><a href="/Menu-TraditionalDrink" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">TraditionalDrink</a></li>
                    <li><a href="/Menu-Food" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">Food</a></li>
                    <li><a href="/Menu-Snack" class="block px-4 py-2 text-gray-800 hover:bg-gray-100">Snack</a></li>
