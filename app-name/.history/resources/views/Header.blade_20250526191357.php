...
<body>
    <section class="relative h-48 bg-cover bg-center">
        ...
        <header class="absolute top-6 left-1/2 transform -translate-x-1/2 z-50 w-[90%] max-w-6xl">
            ...
            <div id="mobile-menu" class="md:hidden mt-2 bg-[#073C21] backdrop-blur-md border border-white/20 rounded-xl text-white shadow-lg px-6 py-4
opacity-0 scale-95 transform transition-all duration-300 origin-top pointer-events-none">
