            ...
            <nav class="bg-[#073C21] backdrop-blur-md border border-white/20 px-6 py-3 rounded-full flex items-center justify-between text-white shadow-lg">
                ...
                <ul class="hidden md:flex gap-6 text-sm uppercase items-center">
                    <li class="relative group">
                        ...
                        <ul class="absolute left-0 mt-2 bg-white text-gray-800 rounded shadow-lg p-2 w-40 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-all duration-300 scale-95 group-hover:scale-100 z-50">
