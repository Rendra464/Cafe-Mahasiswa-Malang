...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <a class="card2" style="height:400px;border-radius:15px" href="#">
        <img src="{{ URL('Coffee.jpg') }}" alt="" style="width:300px;height:350px;border-radius:15px">
    </a>
        ...
        <!-- <button class="custom-button" id="Login-button" style="margin-top:40px;margin-left:5%;background-color:#FFFFFF; color:#5F5D5E">Login</button> -->
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    @auth
                        <a href="{{ url('/') }}" style="border-radius:15px;height: 30px;width: 100px;font-weight: bold;" class="text-sm text-gray-700 dark:text-gray-500">{{ Auth::user()->name }}</a>
                    @else
