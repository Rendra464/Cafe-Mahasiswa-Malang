...
for (let i of products.datakopi) {
    ...
    card.addEventListener('click', function(){
        ...
        for(let card of cards){
            ...
            if (cardProductName === productName) {
                ...
                // DescContainer.setAttribute(" ", i.description);
                // DescriptionDiv.appendChild(DescContainer);
            }
    ...
    let validId = i.productName.toLowerCase().replace(/\s+/g, '-');
    name.id = validId;
    validId.style.font = "Inter, sans-serif";
