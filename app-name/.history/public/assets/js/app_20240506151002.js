...
for (let i of products.datakopi) {
    ...
    card.addEventListener('click', function(){
        ...
        for(let card of cards){
            let cardProductName = card.querySelector('.productName').innerText.toLowerCase();
            if (cardProductName === productName) {
                ...
                description.textContent = i.description; // Assuming there's a "description" property in your data
