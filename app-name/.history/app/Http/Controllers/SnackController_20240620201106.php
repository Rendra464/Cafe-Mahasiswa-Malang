...
class SnackController extends Controller
{
    public function storeRating(Request $request, $id)
    {
        ...
        $validatedData = $request->validate([
            ...
            'columnName' => 'required|string|in:Kentang_Goreng,Pisang_Nugget,Pentol,Nugget,Sosis,Tahu_Walik,Roti_Bakar,Cireng,Tahu_Bakso,Tempura,Pisang_Goreng_Ori,Telu,Keju',
